...
App({
    ...
    onLaunch() {
            ...
            mpserverless.db.collection("school").find()
                .then(res => {
                    ...
                    for (var i = 0; i < allvalue.result.length; i++)
                        schools.push(allvalue.result[i])
                    mpserverless.db.collection("school").find({ skip: 20 })
                        .then(res => {
                            ...
                            that.findprogram(schools, mpserverless);
        ...
        if (!citys) {
            ...
            var allvalue;
            mpserverless.db.collection("city").find()
                .then(res => {
                    allvalue = res.result
        ...
        if (!msg) {
            ...
            msg = [
                ...
                { "name": "Marinochka", "school": "托木斯克国立大学", "pic": "https://wx1.sinaimg.cn/mw2000/0085wEMdly1h4nn1ojn2wj30u00u1dj8.jpg", "degree": "金融学博士", "id": 3, "list": [] },
        ...
        if (!citypics) {
            ...
            var allcitypics;
            mpserverless.db.collection("citypic").find()
                .then(res => {
                    allcitypics = res.result[0].pic
        ...
        if (!schoolpics) {
            ...
            mpserverless.db.collection("schoolpic").find()
                .then(res => {
                    console.log(res)
                    allschoolpics = res.result[0].school
        ...
        try {
            ...
            if (!collection) {
                ...
                const _ = mpserverless.db.command
    ...
    findprogram(schools, mpserverless) {
        var that = this;
